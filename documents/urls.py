...
urlpatterns = [
    ...
    path('<int:pk>/flashcards', views.Flashcards.as_view(), name='document-flashcards'),
    path('<int:pk>/flashcards/feedback', views.Feedback.as_view(), name='flashcard-feedback'),
]